...
session_start();
include '../config.php';
if (isset($_SESSION["email"]) && isset($_SESSION["accountType"]) && $_SESSION["accountType"] == 2 && $_POST && isset($_POST["id"]) && $conn)
{
	...
	if (mysqli_num_rows($query1) > 0)
	{
		...
		{
			if ($row["professionalEmail"] == mysqli_real_escape_string($conn, $_SESSION["email"]))
			{
