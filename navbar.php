...
?><a href="/index.php">Home</a>
	...
	else
	{
		...
		{
			echo "<a href=\"client/searchforbarbershop.php\">Search for a Barbershop</a>";
			echo "<a href=\"client/searchforprofessional.php\">Search for a Professional</a>"; // this is where they can make appointments
			...
			if ($conn)
			{
				...
				if (mysqli_num_rows($result3) > 0)
					echo "<a href=\"client/viewReviews.php\">View Reviews</a>";
				if ($numAppointments > 0)
					echo "<a href=\"client/changeAppointments.php\">Change Appointments</a>";
				if (is_null($vip) || $vip != "" || $vip == 0)
					echo "<a href=\"client/becomeVip.php\">Become a VIP</a>";
				else
					echo "<a href=\"client/manageVIP.php\">Manage VIP Status</a>";
			}
		}
		elseif ($_SESSION["accountType"]==2)
		{
			if ($conn)
			{
				...
				{
					echo "<a href=\"professional/confirmAppointments.php\">Confirm Appointments</a>
					<a href=\"professional/viewSchedule.php\">View Schedule</a>";
					...
					echo "<a href=\"professional/checkReviews.php\">Check Reviews";
					if ($unreadreviews > 0)
						echo " ($unreadreviews)";
					echo "</a>";
				}
				...
				{
					echo "<a href=\"professional/setupBarbershop.php\">Set Up Barbershop</a>";
				}
			}
		}
...
if (isset($_SESSION["accountType"]))
{
	if ($_SESSION["accountType"] == 1 && $conn)
	{
		...
		<a href=\"client/profilepicture.php\">$name2</a>
		<a href=\"logout.php\">Log-out</a>
		<a href=\"changepassword.php\">Change Password</a>";
		if ($numAppointments > 0)
		{
		echo "<a href=\"client/myBarbershops.php\">My Barbershops</a>
		<a href=\"client/myProfessionals.php\">My Professionals</a>";
		}
	}
	elseif ($_SESSION["accountType"] == 2 && $conn)
	{
		...
		{
			echo "<a href=\"/professional/barbershopPage.php\">$name2</a>";
		}
		else
		{
			echo "<a href=\"/professional/setupBarbershop.php\">$name2</a>";
		}
